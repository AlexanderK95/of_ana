...
gaze_df = pd.read_csv("Data/20220923-131939_1_gaze.csv", sep=",")
...
x = gaze_df['time'][0:500].map(shiftToZero)
y1 = gaze_df['rot.x'][0:500].map(shiftToZero)
y2 = gaze_df['rot.y'][0:500].map(shiftToZero)
